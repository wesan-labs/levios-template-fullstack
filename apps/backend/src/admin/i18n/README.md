...
The Levios Admin dashboard supports multiple languages for its interface. Levios uses [react-i18next](https://react.i18next.com/) to manage translations in the admin dashboard.
...
```tsx
import { defineWidgetConfig } from "@wesan-labs/levios-admin-sdk"
import { Button, Container, Heading } from "@wesan-labs/levios-ui"
...
Learn more about translating admin extensions in the [Translate Admin Customizations](https://docs.leviosjs.com/learn/fundamentals/admin/translations) documentation.
